...
router.get( '/category/:category?/:page?/:pageSize?', getPaginatedProducts );   // Obtener todos los productos paginados
...
router.get( '/user/category/:category?/:page?/:pageSize?', authUser, getPaginatedProducts );
