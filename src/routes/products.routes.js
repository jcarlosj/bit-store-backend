...
const { getProducts, getProductById, createProduct, updateProductById, removeProductById } = require('../controllers/products.controller');
const router = Router();
...
router.put( '/:id', updateProductById );        // Actualiza todo el producto por ID
router.patch( '/:id', updateProductById );      // Actualiza parcialmente el producto por ID
